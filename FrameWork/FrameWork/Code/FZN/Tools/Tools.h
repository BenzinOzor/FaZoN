...
namespace fzn
{
	namespace Tools
	{
		...
		FZN_EXPORT std::string open_file( std::string_view _filter = {}, std::string_view _dialog_title = {} );
		FZN_EXPORT std::string save_file_as( std::string_view _filter = {}, std::string_view _force_extension = {}, std::string_view _dialog_title = {} );
	} //namespace Tools
} //namespace fzn
